...
const Login = ({ setName, setRoles, setIsAuthenticated }) => {
  ...
  }, [setIsAuthenticated, setName, setRoles]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (content.message === "Login successful") {
        ...
        document.cookie = `jwt=${content.token}; path=/; Secure; HttpOnly; SameSite=Strict`;
